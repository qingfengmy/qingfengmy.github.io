...
## 1. 需求场景
html中的长列表图片，和android的不一样，android的listview有缓存功能，只有当前一屏有效，而html中的长列表虽然只有看起来的只有那么几个，但实际屏幕外有很多，如果不做分页，上百上千也是有可能的。
虽然可以用虚拟列表来做，但是图片组件本身应该也是要支持懒加载属性的。
## 2. 图片组件的封装功能
...
## 5. r-img-lazyload
> [https://github.com/DrawAChicken/r-img-lazyload/blob/master/README_CN.md](https://github.com/DrawAChicken/r-img-lazyload/blob/master/README_CN.md)
