export default [
  ...
  },
  {
    ...
    routes: [
      ...
      { name: '查询表格', icon: 'smile', path: '/list/table-list', component: './list/table-list' },
  ...
  },
  {
    ...
    routes: [
      ...
      { name: '流程编辑器', icon: 'smile', path: '/editor/flow', component: './editor/flow' },
      { name: '脑图编辑器', icon: 'smile', path: '/editor/mind', component: './editor/mind' },
      { name: '拓扑编辑器', icon: 'smile', path: '/editor/koni', component: './editor/koni' },
    ],
  },
  { path: '/', redirect: '/index' },
  { component: '404' },
